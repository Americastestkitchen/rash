...
describe Hashie::Crash do
  ...
  it "should merge well with a Mash" do
    ...
    merged.nested3.should be_a(Hashie::Crash)
  ...
  it "should update well with a Mash" do
    ...
    subject.nested3.should be_a(Hashie::Crash)
